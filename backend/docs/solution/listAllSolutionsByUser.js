export const listUserSolutionsDoc = {
  "/api/solutions/auth/{id}/enterprises/{enterpriseId}/users/{userId}": {
    get: {
      tags: ["Soluções"],
      summary: "Lista todas as soluções de um usuário específico",
      description:
        "Retorna soluções paginadas de um usuário em uma empresa. Acesso permitido para usuários autenticados (empresas ou funcionários)",
      security: [
        {
          BearerAuth: [],
        },
      ...
      parameters: [
        ...
        },
        {
          name: "userId",
          in: "path",
          description: "ID do usuário dono das soluções",
          required: true,
          schema: {
            type: "string",
      ...
      responses: {
        200: {
          description: "Lista de soluções do usuário retornada com sucesso",
          content: {
            "application/json": {
              schema: {
                type: "object",
