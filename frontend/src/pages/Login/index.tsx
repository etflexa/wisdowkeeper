...
function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("http://localhost:8080/api/enterprises/login", {
        method: "POST",
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-4 sm:p-8">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Acesso ao WisdomKeeper</h1>
          ...
          {!userType ? (
            <div className="space-y-6 animate-fade-in">
              <div className="text-center mb-6">
                <p className="text-gray-700 mb-4">Selecione o tipo de acesso:</p>
              </div>
            ...
            <div className="animate-fade-in">
              ...
              <h2 className="text-xl font-semibold text-gray-800 mb-2">
                {userType === "employee" ? "Acesso do Funcionário" : "Acesso da Empresa"}
              </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center pt-2">
                  {userType === "company" && (
                    <div className="mt-2">
                      <a href="/cadastro-empresa" className="text-sm text-green-600 hover:text-green-800 hover:underline">
                      <Link
                          to="/cadastroempresa"
                        >
